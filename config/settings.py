"""
Django settings for skillhub-events project.
...
# reading .env file if DEBUG is False
...
SECRET_KEY = 'django-insecure-=)x7*7e!9t8^s1p%2(89($ks*e$ihrs&3@yqq6zn)fd^^cp3qb'
